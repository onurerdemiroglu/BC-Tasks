...
public class OrderPageObject
{
    ...
    public IWebElement GiftNoteTextArea => Driver.get().FindElement(ReceivedOrderLocators.GiftNoteTextArea);
    ...
    public static class ReceivedOrderLocators
    {
        ...
        public static readonly By GiftNoteTextArea = By.Id("cardMessageTextarea0");
