...
public class Helper
{
    ...
    public void Log(string title, string step, string detail, string status)
    {
        sqlCommand = new SqlCommand("insert into Log(Title,Step, Detail, Status) values (@Title,@Step,@Detail,@Status)", _sqlConnection.DBConnection);
